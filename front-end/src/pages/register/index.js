<<<<<<< HEAD:front-end/src/pages/register/index.js
...
>>>>>>> 708a43a57c71f7fa566f03fb1279ec57bb71b37d:front-end/src/components/CadastroComponents/CadastroComponents.js
    ...
    return(
        <div className={styles.register}>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <label>
                    <span>Telefone:</span>
                    <input type="text" name="phone" required placeholder="Telefone" value={phone}  onChange={(e) => setPhone(e.target.value)}/>
                </label>
                <label>
